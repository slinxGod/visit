...
/***/ function(module, exports, __webpack_require__) {
	...
	var arr = [
	    {
	        title:'<h2 class="text-center">中央控制室</h2>',
	        content:
	    ...
	    {
	        title:'<h2 class="text-center">空压制氮机房、储罐区</h2>',
	        content:'这是我司空压制氮房，有一备一用两套装置，是为我厂区提供气源及惰性气体，可以同时产\n' +
	            '生压缩空气和惰性气体，所有自动化控制的阀门都是通过我们的压缩空气来提供动力；惰性\n' +
	            '气体主要保证油墨的品质和安全操作。\n' +
	            '储罐区内有 12 个 50 立方的储罐，能存储各类化工原料和成品，阀门和泵组都是通过自动化\n' +
	            '控制系统实现远程操作，包括罐体的液位体积、压力、温度都是由中央控制室集中监管。\n'
	    },
	    {
	        title:'<h2 class="text-center">储罐区</h2>',
	        content:'这是我司空压制氮房，有一备一用两套装置，是为我厂区提供气源及惰性气体，可以同时产\n' +
	            '生压缩空气和惰性气体，所有自动化控制的阀门都是通过我们的压缩空气来提供动力；惰性\n' +
	            '气体主要保证油墨的品质和安全操作。\n'
	    },
	    {
	        title:'<h2 class="text-center">4楼水性涂层车间***</h2>',
	        content:'水性涂层车间是由 5 楼原料储存，经过管道输送到 4 楼的反应釜，由气动阀集中控制开关，\n' +
	            '可以通过控制面板按产品型号、数量，由系统一键启动配料生产、搅拌均匀化验合格后由管\n' +
	            '道输送至成品罐区内进行包装。\n'
	    },
	    {
	        title:'<h2 class="text-center">3楼智能投料</h2>',
	        content:'这是油墨生产从三楼投粉配料，通过管道输送到二楼。'
	    },
	    {
	        title:'<h2 class="text-center">2 楼检验室、凹版设备、2 条油墨生产线***</h2>',
	        content:'这是 2 楼的检验室，这里是检验树脂原料、投料检验，通过精密仪器对各数据进行分析比对，\n' +
	            '确保生产精准。\n' +
	            '这 3 台为凹版油墨生产设备。\n' +
	            '这是油墨生产线，通过管道由 3 楼投料下来，自动系统内存储各油墨配方，可一键启动开启\n' +
	            '自动按配方比例投料、自动停止及搅拌。其中这一台珠磨机是目前中国大型设备之一\n'
	    },
	    {
	        title:'<h2 class="text-center">1 楼两条油墨生产线、全自动灌装包装生产线***</h2>',
	        content:'一楼是油墨包装区，所有油墨通过管道投料调整下来，由三辊机三次研磨再两道过滤，抽真\n' +
	            '空包装；全自动灌装包装生产线为我司自主研发生产线，实现一人操作包装。\n'
	    },
	    {
	        title:'<h2 class="text-center">检验室 现场测数据</h2>',
	        content:'一楼检验室对包装前油墨作数据检测，每批油墨均有数据留底及留样。'
	    },
	    {
	        title:'<h2 class="text-center">配方输出中心</h2>',
	        content:'油墨所有的配方都是从这里分析、输出至生产，所有数据通过打样出具。'
	    },
	    {
	        title:'<h2 class="text-center">甲类车间</h2>',
	        content:'甲类车间：我们有中间储存罐 20 台，其中 8 立方的 8 台、10 立方的 7 台、5 立方的 5 台，有\n' +
	            '3 台自动罐装机，可实现年产值 20 亿。\n'
	    },
	    {
	        title:'<h2 class="text-center">连接料存储区</h2>',
	        content:'这是油墨的连接料储存罐，生产时通过管道输送到相关区域。'
	    },
	    {
	        title:'<h2 class="text-center">树脂车间</h2>',
	        content:'这是树脂生产车间，油墨所需的树脂由我司自主生产。'
	    },
	    {
	        title:'<h2 class="text-center">丙类仓库</h2>',
	        content:'丙类仓库内货物是当天发货的中转区，所有我司生产的产品不设库存，收到订单再安排生产，\n' +
	            '货物入仓后打托整理清点后发货。\n'
	    },
	    {
	        title:'<h2 class="text-center">橡皮布车间</h2>',
	        content:'这这是橡皮布裁切车间，所有订单从这里统一安排。'
	    },
	    {
	        title:'<h2 class="text-center">科研楼</h2>',
	        content:'这是凹版油墨、光油等的研发实验室，我们通过精密仪器对原料、配方进行分析配制。'
	    },
	    {
	        title:'<h2 class="text-center">供墨系统演示区</h2>',
	        content:'这台全自动袋装供墨系统，有 4 大特点：\n' +
	            '1）触屏系统操作更简单，实时感应墨位，自动精准供墨\n' +
	            '2）智能恒温控制，稳定油墨流动性，提升印刷质量，特别在北方天气寒冷时，墨箱可以保持\n' +
	            '内部温度平衡，油墨流动性更佳。\n' +
	            '3）油墨损耗极少仅 0.3%，节源又环保，16KG 袋装油墨殘墨量仅为 50 克以内，减少固废处\n' +
	            '理\n' +
	            '4）大大减少人力、降低成本，性价比高；全自动操作无需像传统挖墨操作，只需打开开关球\n' +
	            '阀、启动供墨按钮即可实施供墨\n'
	    }
	]
...
//# sourceMappingURL=index.js.map?v=b2a3450ff147caaf5396