...
/***/ function(module, exports, __webpack_require__) {
	...
	var arr = [
	    ...
	    },
	    {
	        ...
	        content:'<p>这是我司空压制氮房，有一备一用两套装置，是为我厂区提供气源及惰性气体，可以同时产' +
	            '生压缩空气和惰性气体，所有自动化控制的阀门都是通过我们的压缩空气来提供动力；惰性' +
	            '气体主要保证油墨的品质和安全操作。</p>' +
	            '<p>储罐区内有 12 个 50 立方的储罐，能存储各类化工原料和成品，阀门和泵组都是通过自动化' +
	            '控制系统实现远程操作，包括罐体的液位体积、压力、温度都是由中央控制室集中监管。</p>'
	    },
	    {
	    ...
	    },
	    {
	        ...
	        content:'<p>水性涂层车间是由 5 楼原料储存，经过管道输送到 4 楼的反应釜，由气动阀集中控制开关，' +
	    ...
	    },
	    {
	        ...
	        content:'<p>这是 2 楼的检验室，这里是检验树脂原料、投料检验，通过精密仪器对各数据进行分析比对，' +
	            '确保生产精准。' +
	            '这 3 台为凹版油墨生产设备。' +
	            '这是油墨生产线，通过管道由 3 楼投料下来，自动系统内存储各油墨配方，可一键启动开启' +
	            '自动按配方比例投料、自动停止及搅拌。其中这一台珠磨机是目前中国大型设备之一</p>'
	    },
	    {
	        title:'<h2 class="text-center" style="text-align: center">1 楼两条油墨生产线、全自动灌装包装生产线***</h2>',
	        content:'<p>一楼是油墨包装区，所有油墨通过管道投料调整下来，由三辊机三次研磨再两道过滤，抽真' +
	            '空包装；全自动灌装包装生产线为我司自主研发生产线，实现一人操作包装。</p>'
	    },
	    {
	    ...
	    },
	    {
	        ...
	        content:'<p>甲类车间：我们有中间储存罐 20 台，其中 8 立方的 8 台、10 立方的 7 台、5 立方的 5 台，有' +
	            '3 台自动罐装机，可实现年产值 20 亿。</p>'
	    },
	    {
	    ...
	    },
	    {
	        ...
	        content:'<p>丙类仓库内货物是当天发货的中转区，所有我司生产的产品不设库存，收到订单再安排生产，' +
	            '货物入仓后打托整理清点后发货。</p>'
	    },
	    {
...
//# sourceMappingURL=index.js.map?v=c1d372eff15b0780a91f